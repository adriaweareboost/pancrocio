...
const BRAND_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 53 48" width="80" height="72" style="vertical-align:middle">
...
function renderSidebar(ui: ReportUiStrings): string {
  return `
...
function renderMobilePopup(ui: ReportUiStrings): string {
  return `
...
function renderContactCta(ui: ReportUiStrings): string {
  return `
