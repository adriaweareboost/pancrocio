...
<body>
  ...
  <header class="report-header" role="banner" style="background:#070F2D;color:white;padding:40px 20px 48px;text-align:center;margin-bottom:0;position:relative">
    ...
    <div style="max-width:800px;margin:0 auto">
      <a href="https://scanandboost.weareboost.online" target="_blank" rel="noopener" style="text-decoration:none;display:inline-block;margin-bottom:12px" aria-hidden="true">${BRAND_SVG.replace('width="200" height="61"', 'width="260" height="80"')}</a>
      <h1 style="position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0">Scan&amp;Boost — ${escapeHtml(ui.reportSubtitle)}</h1>
